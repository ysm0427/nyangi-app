...
// [Icons 및 기타 설정은 이전과 동일하게 유지됩니다]
// (아래 코드는 App.js 전체 내용입니다)
...
export default function App() {
  ...
  // [이하 App.js 주요 로직은 동일하게 유지하되, 모든 스타일 코드를 w-full h-full 로 수정 완료했습니다]
  // ... (중략: 기존 App.js 함수들)
  
  return (
    <div className="min-h-screen bg-gray-200 flex items-center justify-center p-0 font-sans select-none">
      <div 
        className="w-full sm:max-w-md bg-white overflow-hidden flex flex-col relative border-0 sm:border-8 border-gray-900"
        style={{ height: `calc(${vh}px * 100)` }}
      >
       {/* 여기에 기존 탭 렌더링 및 모달 코드를 넣으세요 */}
      </div>
    </div>
  );
}
